        ...
        <div className="border-t border-white/20 pt-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a href="https://www.instagram.com/rayalonglifeayurveda?igsh=MW9vMXNvNzkyNTVsdQ%3D%3D" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" className="text-white hover:text-white/70 transition-colors duration-200">
              ...
              <a href="https://www.facebook.com/Rayalonglife/" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook" className="text-white hover:text-white/70 transition-colors duration-200">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-2">
            ...
            {submitted ? (
              <div className="flex items-center gap-2 border border-white/30 rounded px-3 py-2">
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 bg-transparent border text-white placeholder-white/60 text-xs px-3 py-2 rounded focus:outline-none focus:border-white ${
                      emailError ? "border-red-400" : "border-white/50"
                    }`}
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  />
                  <button
                    type="submit"
                    disabled={submitting}
                    className="bg-transparent border border-white text-white text-xs px-4 py-2 rounded hover:bg-white hover:text-[#5E17EB] disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 font-semibold tracking-wider flex-shrink-0"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    {submitting ? "..." : "JOIN"}
                  </button>
                ...
                {emailError && (
                  <p className="text-red-300 text-[10px] mt-1" style={{ fontFamily: "Poppins, sans-serif" }}>
                    {emailError}
                  </p>
                )}
              </form>
